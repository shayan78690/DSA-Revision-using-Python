class Solution(object):
    ...
    def func(self, prices, n, day, buy):
        ...
        if buy:
            ...
            sellToday = prices[day] + self.func(prices, n, day+2, 1)
...
class Solution(object):
    ...
    def func(self, prices, n, day, buy, dp):
        ...
        if buy:
            ...
            sellToday = prices[day] + self.func(prices, n, day + 2, 1, dp)
            hold = self.func(prices, n, day + 1, 0, dp)
        ...
        for day in range(n - 1, -1, -1):
            for buy in range(2):
                ...
                if buy:
                    ...
                    sellToday = prices[day] + dp[day + 2][1]
                    hold = dp[day + 1][0]
                    dp[day][buy] = max(sellToday, hold)
